...
export async function setQuestion(newQuestion, endDate) {
    const { contract, gateway } = await getContract('admin');
    await contract.submitTransaction('setQuestion', newQuestion, endDate);
...
export async function getQuestion() {
    ...
    await gateway.disconnect();
    return JSON.parse(question.toString());
}
